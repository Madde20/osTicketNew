...
<?php if ($openTickets) { ?>
    ...
    <?php echo ('Open'); if ($openTickets > 0) echo '<span class="badge">'.sprintf(' %d', $openTickets).'</span>'; ?>
         </a></li>
...
if ($closedTickets) {?>
   <li role="presentation" class="<?php if ($status == 'closed') echo 'active'; ?>">
        ...
        <?php echo __('Closed'); if ($closedTickets > 0) echo '<span class="badge">'.sprintf(' %d', $closedTickets).'</span>'; ?>
        </a>
    </li>
<?php } ?>
    </ul>
