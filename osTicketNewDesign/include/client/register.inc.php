...
?>
  ...
  <div><h3><?php echo __('Preferences'); ?><hr></h3></div>
...
<div class="col-sm-10">
        <input type="password" size="18" class="form-control" name="passwd1" maxlength="128" value="<?php echo $info['passwd1']; ?>"></div>
...
<div class="col-sm-10">
        <input type="password" size="18" class="form-control" name="passwd2" maxlength="128" value="<?php echo $info['passwd2']; ?>"></div>
