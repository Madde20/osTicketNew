...
<div>
    ...
    <div class="sticky bar tbar">
       <div class="content">
        <div class="pull-right title-right-icons">
            <?php
...
<?php           if ($thisstaff->hasPerm(Email::PERM_BANLIST)
                ...
                <a href="#post-reply" class="post-response action-button span-a"
                data-placement="bottom" data-toggle="tooltip"
                title="<?php echo __('Post Reply'); ?>"><i class="icon-mail-reply"></i></a>
                <?php
                } ?>
                <a href="#post-note" id="post-note" class="post-response action-button span-a"
                data-placement="bottom" data-toggle="tooltip"
...
<div class="col-md-6 col-lg-6 pos-int"> 
...
<div class="col-md-12 col-lg-12"> 
     <div class="panel panel-info">
    <table class="ticket_info custom-data table table-striped" cellspacing="0" cellpadding="0" width="940" border="0">
    <thead>
...
>
    ...
    if ($role->hasPerm(Ticket::PERM_REPLY) && !($blockReply)) {
        ...
        ?>
    <form id="reply" class="tab_content spellcheck exclusive save form-horizontal"
        ...
        <input type="hidden" name="lockCode" value="<?php echo $mylock ? $mylock->getCode() : ''; ?>">
            <?php
            if ($errors['reply']) {?>
            <div class="alert alert-danger"><?php echo $errors['reply']; ?>&nbsp;</div>
            <?php
            }?>
            
           <div class="form-group" id="to_sec">
                    <label class="control-label col-sm-2"><strong><?php echo __('From'); ?>:</strong></label>
                    <div class="col-sm-10">
                    <select class="form-control" id="from_email_id" name="from_email_id">
                     <?php
             ...
             <div class="form-group" id="recipients">
                ...
                <label class="control-label col-sm-2"><strong><?php echo __('Recipients'); ?>:</strong></label>
                <div class="col-sm-10">
            ...
            <?php
             ...
             <div class="form-group">
                    <label class="control-label col-sm-2"><strong><?php echo __('Reply To'); ?>:</strong></label>
                <div class="col-sm-10">
                   <?php
            ...
            <div class="form-group" id="resp_sec">
                    <label class="control-label col-sm-2"><strong><?php echo __('Response');?>:</strong></label>
               <div class="col-sm-10">
                <?php
                if ($errors['response'])
...
<?php } # endif (canned-resonse-enabled) ?>
    ...
    ?></textarea>
           ...
           <div class="form-group">
                         <label for="signature" class="control-label col-sm-2"><?php echo __('Signature');?>:</label>
                <div class="col-sm-10">
                    <?php
                    ...
                    <label class="radio-inline"><input type="radio" name="signature" value="mine"
             ...
             <div class="form-group">
                         <label for="signature" class="control-label col-sm-2"><strong><?php echo __('Ticket Status');?>:</strong></label>
                <div class="col-sm-10">
                    <?php
                    $outstanding = false;
                    if ($role->hasPerm(Ticket::PERM_CLOSE)
        ...
        <p  style="text-align:center;">
            <br>
            <input class="btn btn-default save pending" type="submit" value="<?php echo __('Post Reply');?>">
    ...
    if (!($blockReply)) {
    ?>    
    <form id="note" class="hiddenfi tab_content spellcheck exclusive save"
        data-lock-object-id="ticket/<?php echo $ticket->getId(); ?>"
        data-lock-id="<?php echo $mylock ? $mylock->getId() : ''; ?>"
        ...
        <input type="hidden" name="lockCode" value="<?php echo $mylock ? $mylock->getCode() : ''; ?>">
            ...
            <?php
            if($errors['postnote']) {?>
            <div class="alert alert-danger"><?php echo $errors['postnote']; ?></div>
            <?php
            } ?>

                <div class="form-group">
                         <label class="control-label col-sm-2"><strong><?php echo __('Internal Note'); ?>:</strong><span class='error'>&nbsp;*</span></label>
                 <div class="col-sm-10">
                        <div class="faded"><?php
    ...
    echo $attrs; ?>><?php echo ThreadEntryBody::clean($_POST ? $info['note'] : $draft);
       ...
       <p style="text-align:center;"><br>
           <input class="btn btn-default save pending" type="submit" value="<?php echo __('Post Note');?>">
           <input class="btn btn-default" type="reset" value="<?php echo __('Reset');?>">
       </p>
   </form>
   <?php } ?>
