...
<div>
    <div class="sticky bar">
       <div class="content">
        ...
        <div class="flush-right title-right-icons task-icons">
            <?php
            if ($ticket) { ?>
            <a  id="task-view"
                target="_blank"
...
<div class="col-md-6 col-lg-6"> 
     <div class="panel panel-info">
         <div class="panel-body">
                <table  class="table table-striped" border="0" cellspacing="" cellpadding="4" width="100%">
                    <tr>
...
<div class="col-md-6 col-lg-6"> 
           <div class="panel panel-success">
               <div class="panel-body">
                <table class="table table-striped" cellspacing="0" cellpadding="4" width="100%" border="0">
...
?>
<div id="task_response_options" class="<?php echo $ticket ? 'ticket_task_actions' : ''; ?> sticky bar stop actions task-cls">
    <ul class="tabs">
        <?php
    ...
    echo $attrs; ?>><?php echo $draft ?: $info['task.response'];
            ...
            <tr>
                <td>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2"><?php echo __('Status');?>
                        </label>
                         <div class="col-sm-10">
       ...
       <p  style="text-align:center;">
           <input class="btn btn-default save pending" type="submit" value="<?php echo __('Post Update');?>">
    ...
    <form id="task_note"
        ...
        class="tab_content spellcheck save <?php
            echo $role->hasPerm(TaskModel::PERM_REPLY) ? 'hiddenfi' : ''; ?>"
        name="task_note"
