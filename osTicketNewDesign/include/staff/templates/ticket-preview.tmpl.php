...
echo '
        <li class="active"><a data-toggle="tab" id="preview_tab" href="#preview"
            ><i class="icon-list-alt"></i>&nbsp;'.__('Ticket Summary').'</a></li>';
if ($thread && $thread->getNumCollaborators()) {
echo sprintf('
        <li><a data-toggle="tab" id="collab_tab" href="#collab"
            ><i class="icon-fixed-width icon-group
            faded"></i>&nbsp;'.__('Collaborators (%d)').'</a></li>',
            $thread->getNumCollaborators());
}
echo '<li><a data-toggle="tab" id="thread_tab" href="#threadPreview"
            ><i class="icon-fixed-width icon-list
            faded"></i>&nbsp;'.__('Thread Preview').'</a></li>';

echo '</ul>';
echo '<div id="ticket-preview_container" class="table-responsive tab-content">';
echo '<div class="tab-pane fade active in" id="preview">';
echo '<table class="ticket_info table table-striped">';
...
echo '<hr>
    <table class="ticket_info table table-striped">';
if($ticket->isOpen()) {
    echo sprintf('
            <tr>
...
<div class="tab-pane fade" id="collab">
...
<div class="tab-pane fade thread-preview" id="threadPreview">
    <div id="ticketThread">
        <div id="thread-items">
        <?php
