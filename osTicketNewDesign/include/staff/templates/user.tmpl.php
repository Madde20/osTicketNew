...
<?php if ($thisstaff->hasPerm(User::PERM_EDIT)) { ?>
    <a href="<?php echo $info['useredit'] ?: '#'; ?>" id="edituser" class="btn action" title="<?php echo __('Edit'); ?>"><i class="icon-edit"></i></a>
<?php }
      if ($thisstaff->hasPerm(User::PERM_DIRECTORY)) { ?>
    <a href="users.php?id=<?php echo $user->getId(); ?>" title="<?php
        echo __('Manage User'); ?>" class="action"><i class="btn icon-share"></i></a>
<?php } ?>
</div>
    <table class="table custom-info" width="100%">
...
<?php } ?>
    <table class="custom-info table" width="100%">
