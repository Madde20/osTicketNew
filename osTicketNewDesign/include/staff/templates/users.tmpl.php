...
<div class="pull-right flush-right" style="margin-bottom:10px;">
    <a href="#orgs/<?php echo $org->getId(); ?>/add-user" class="btn btn-default btn-xs green button action-button add-user"
        ><i class="icon-plus"></i> <?php echo __('Add User'); ?></a>
    <a href="#orgs/<?php echo $org->getId(); ?>/import-users" class="btn btn-default btn-xs button action-button add-user">
        <i class="icon-cloud-upload icon-large"></i>
    <?php echo __('Import'); ?></a>
    <button id="actions" class="btn btn-default btn-xs red button action-button" type="submit" name="remove-users"><i class="icon-trash"></i> <?php echo __('Remove'); ?></button>
</div>
<?php } ?>
<div class="clear"></div>
<?php
