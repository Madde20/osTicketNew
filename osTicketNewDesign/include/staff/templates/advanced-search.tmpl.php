...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#criteria"><i class="icon-search"></i> <?php echo __('Criteria'); ?></a></li>
    <li><a  data-toggle="tab" href="#columns"><i class="icon-columns"></i> <?php echo __('Columns'); ?></a></li>
    <?php
    if ($search->isSaved()) { ?>
    <li><a data-toggle="tab" href="#settings"><i class="icon-cog"></i> <?php echo __('Settings'); ?></a></li>
    <?php
    } ?>
</ul>
  <br>
...
<div>
  ...
  <div id="save-changes" class="<?php echo $save ? '' : 'hidden'; ?>" style="padding:5px; border-top: 1px dotted #777;">
    <?php if ($parent_id) { ?>
      ...
      <?php } ?>
      <div><input class="btn btn-default" name="queue-name" type="text" size="40"
        ...
        <span class="buttons">
             <button class="btn btn-default" type="button"  name="save-search"
 ...
 <div>
  <p class="full-width">
    <span class="buttons pull-left">
        <input type="button"  name="cancel"  class="btn btn-default close" value="<?php echo __('Cancel'); ?>">
        <?php
        if ($search->isSaved()) { ?>
        <input type="button" name="done" class="btn btn-default done" value="<?php echo
            __('Done'); ?>" >
        <?php
        } ?>
    </span>
    <span class="buttons pull-right">
      ...
      <button class="btn btn-default" type="submit" name="save" value="save"
