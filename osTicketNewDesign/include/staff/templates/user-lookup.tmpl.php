<div id="the-lookup-form" class="popup-table">
...
<form method="post" class="user" action="<?php echo $info['action'] ?: '#users/lookup/form'; ?>">
    ...
    <hr>
    <div class="full-width add-user-btn-group">
        <span class="buttons pull-left">
            <input class="btn btn-default reset" type="reset" value="<?php echo __('Reset'); ?>">
            <input type="button" name="cancel" class="btn btn-default <?php echo $user ?  'cancel' : 'close' ?>"  value="<?php echo __('Cancel'); ?>">
        </span>
        <span class="buttons pull-right">
            <input class="btn btn-default add-user" type="submit" value="<?php echo __('Add User'); ?>">
        </span>
        <div class="clear"></div>
     </div>
