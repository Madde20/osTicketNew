...
return false;">
    ...
    <div class="input-group attached ticketing-filter">
      <input type="text" class="form-control basic-search" data-url="ajax.php/tickets/lookup" name="query"
    ...
    <div class="ticketing-filter-adv">
    <a href="#" onclick="javascript:
        $.dialog('ajax.php/tickets/search', 201);"
        >[<?php echo __('advanced'); ?>]</a>
        <i class="help-tip icon-question-sign" href="#advanced"></i></div><div class="clear"></div>
...
<div class="clear"></div>
<div class="col-md-12 task-list ticket-list">
...
<table class="table table-bordered list list queue tickets" border="0" cellspacing="1" cellpadding="2" width="940">
  <thead>
    <tr>
<?php
