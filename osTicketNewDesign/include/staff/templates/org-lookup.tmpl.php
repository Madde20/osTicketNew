...
<form method="post" class="org" action="<?php echo $info['action'] ?: '#orgs/add'; ?>">
    ...
    <div class="full-width add-user-btn-group">
        <span class="buttons pull-left">
            ...
            <input type="button" name="cancel" class="btn btn-default <?php echo $org ? 'cancel' : 'close' ?>"
                value="<?php echo __('Cancel'); ?>">
        </span>
        <span class="buttons pull-right">
            <input class="btn btn-default add-user" type="submit" value="<?php echo __('Add Organization'); ?>">
        </span>
     </div>
</form>
</div>
