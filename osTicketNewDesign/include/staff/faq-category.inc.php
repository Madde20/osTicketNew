...
echo sprintf('<div class="col-md-6 col-sm-8 bcolor title-right-icons"><div class="pull-right flush-right">
    <a class="btn btn-default btn-xs green action-button" href="faq.php?cid=%d&a=add">'.__('Add New FAQ').'</a>
...
</div></div>', $category->getId(), $category->getId());
} else {
?><?php
} ?>
    </div>
