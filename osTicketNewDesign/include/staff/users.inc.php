...
<div id="basic_search">
    ...
    <div class="input-group">
                      <input type="text" class="form-control" id="basic-user-search" name="query"
...
<form id="users-list" class="user-pop-td" action="users.php" method="POST" name="staff" >
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6 col-sm-8 bcolor">
                ...
                <a class="btn btn-default btn-xs green button action-button popup-dialog"
                   href="#users/add">
                    <i class="icon-plus-sign"></i>
                    <?php echo __('Add User'); ?>
                </a>
                <a class="btn btn-default btn-xs action-button popup-dialog"
                   href="#users/import">
