...
<div id="basic_search">
    <div class="well">
        <form action="orgs.php" method="get">
            ...
            <input type="search" class="form-control" id="basic-org-search" name="query" autofocus size="30" value="<?php echo Format::htmlchars($_REQUEST['query']); ?>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<div class="col-md-12 org-list">
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-default btn-xs green button action-button add-org"
                   href="#">
