...
<?php if (($account && $account->isConfirmed())
    || $thisstaff->hasPerm(User::PERM_EDIT)) { ?>
            <span class="btn btn-default btn-xs action-button pull-right" data-dropdown="#action-dropdown-more">
                <i class="icon-caret-down pull-right"></i>
                <span><i class="icon-cog"></i> <?php echo __('More'); ?></span>
            </span>
<?php }
    if ($thisstaff->hasPerm(User::PERM_DELETE)) { ?>
            <a id="user-delete" class="red button action-button pull-right user-action span-a"
...
<?php if ($thisstaff->hasPerm(User::PERM_MANAGE)) { ?>
            <?php
            if ($account) { ?>
            <a id="user-manage" class="action-button pull-right user-action span-a"
            href="#users/<?php echo $user->getId(); ?>/manage"><i class="icon-edit"></i>
            <?php echo __('Manage Account'); ?></a>
            <?php
            } else { ?>
            <a id="user-register" class="action-button pull-right user-action span-a"
...
<div class="clear"></div>
<br><br>
<ul class="clean nav nav-tabs" id="user-view-tabs">
    <li class="active"><a data-toggle="tab" href="#tickets"><i
...
<div id="user-view-tabs_container" class="table-responsive tab-content">
...
<div class="dialog" id="confirm-action">
