...
<div id="basic_search">
    ...
    <form action="directory.php" method="GET" name="filter">
        <div class="form-group">
            <input class="form-control" type="text" name="q" value="<?php echo Format::htmlchars($_REQUEST['q']); ?>" > </div>
        ...
        &nbsp;&nbsp;
        <input type="submit" class="btn btn-default leftmar10" name="submit" value="<?php echo __('Filter');?>"/>
