...
<div id='basic_search'>
    ...
    <form action="tasks.php" method="get" onsubmit="javascript:
        ...
        <div class="input-group">
            <input type="text" class="form-control basic-search" data-url="ajax.php/tasks/lookup" name="query"
...
<!-- SEARCH FORM END -->
    ...
    <div class="col-md-12 task-list">
        ...
        <div class="col-md-6 col-sm-8 bcolor align-right title-right-icons">
            <div class="pull-right flush-right">
            <a id="new-task"  title="Open a New Task" data-dialog-config='{"size":"large"}' href="#tasks/add" class="green button span-a new-task"><i class="icon-plus-sign"></i> <?php echo __('New Task');?></a>
           <?php
           if ($count)
...
<?php csrf_token(); ?>
 ...
 <table class="table table-bordered list" border="0" cellspacing="1" cellpadding="2" width="940">
    <thead>
        <tr>
