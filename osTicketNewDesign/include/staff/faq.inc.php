...
<?php } ?>
    ...
    <div class="error"><?php echo $errors['category_id']; ?></div></div></div>
...
?>
   <div class="col-md-6"> <div class="form-group">  
    ...
    <select class="form-control" multiple="multiple" name="topics[]" class="multiselect"
...
<ul class="clean nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#article"><?php echo __('Article Content'); ?></a></li>
    <li><a data-toggle="tab" href="#attachments"><?php echo __('Attachments') . sprintf(' (%d)',
...
<?php if ($i['direction'] == 'rtl') echo 'dir="rtl" class="rtl"'; ?>
    ...
    <div>
    <textarea name="<?php echo $aname; ?>" rows="12"
...
<div id="notes" class="tab-pane fade">
    ...
    <textarea class="richtext no-bar" name="notes" 
        rows="8" style="width: 80%;"><?php echo Format::viewableImages($info['notes']); ?></textarea><br>
</div>
    </div>
...
<p style="text-align:center;">
    ...
    <input class="btn btn-default" type="reset"  name="reset"  value="<?php echo __('Reset'); ?>" onclick="javascript:
        ...
        location.reload();" />
    <input class="btn btn-default" type="button" name="cancel" value="<?php echo __('Cancel'); ?>" onclick='window.location.href="faq.php?<?php echo $qstr; ?>"'>
</p>
</form>
</div>    
