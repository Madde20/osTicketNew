...
<form action="categories.php" method="POST" id="mass-actions">
        ...
        <div class="col-md-6 col-sm-4 bcolor"> 
            ...
            </div> <div class="col-md-6 col-sm-8 bcolor title-right-icons">
            <div class="pull-right flush-right">
                <a href="categories.php?a=add" class="green button span-a">
...
<?php
if ($total) {
    echo '<div class="text-right">&nbsp;'.__('Page').': '.$pageNav->getPageLinks().'</div>';
?>
<p class="centered" id="actions">
    <input class="btn btn-default button" type="submit" name="make_public" value="<?php echo __('Make Public');?>">
    <input class="btn btn-default button" type="submit" name="make_private" value="<?php echo __('Make Internal');?>">
    <input class="btn btn-default button" type="submit" name="delete" value="<?php echo __('Delete');?>" >
</p>
<?php
}
?>
